...
(
umask 077
sed 's/^ \{2\}//' > "/mnt/home/behren23/ondemand/data/sys/dashboard/batch_connect/sys/bc_icer_jupyter_ubuntu/output/d62f898d-0755-4c16-90c9-9a9403834c81/launch_wrapper.sh" << EOL
  #!/usr/bin/env bash
...
chmod 700 "/mnt/home/behren23/ondemand/data/sys/dashboard/batch_connect/sys/bc_icer_jupyter_ubuntu/output/d62f898d-0755-4c16-90c9-9a9403834c81/launch_wrapper.sh"
echo "TTT - $(date)"
...
if grep "jupyter: command not found" "/mnt/home/behren23/ondemand/data/sys/dashboard/batch_connect/sys/bc_icer_jupyter_ubuntu/output/d62f898d-0755-4c16-90c9-9a9403834c81/output.log" > /dev/null; then
  touch "/mnt/home/behren23/ondemand/data/sys/dashboard/batch_connect/sys/bc_icer_jupyter_ubuntu/output/d62f898d-0755-4c16-90c9-9a9403834c81/no-jupyter.error"
fi
